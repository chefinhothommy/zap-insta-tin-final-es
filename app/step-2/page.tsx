    ...
    <>
      <div className="bg-red-600 text-center py-2.5 px-4">
        <p className="text-sm font-semibold">
          ...
          <span className="text-yellow-300">Tu pago aún está siendo procesado.</span>
        </p>
      </div>
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center px-4 py-12">
        <main className="w-full max-w-md mx-auto text-center space-y-8">
          <p className="text-lg text-gray-800">
            <span className="font-bold text-red-600">¡ATENCIÓN!</span> Nuestro sistema ha identificado que muchas de las
            nuevas conversaciones de Instagram se están completando en WhatsApp.
          </p>
          ...
          <div className="w-full space-y-6">
            <div className="w-full space-y-4 text-left">
              <h2 className="font-semibold text-gray-800 text-lg">¿Qué género es?</h2>
